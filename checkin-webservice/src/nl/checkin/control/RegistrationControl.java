...
public class RegistrationControl {
	...
	public void register(int user_id, String inputToken, Registration registration) throws SQLException,
	...
	public void checkIn(Registration registration) throws SQLException, NamingException {
	...
	public void checkOut(Registration registration) throws SQLException, ParseException, NamingException {
	 ...
	 try {
			...
			while (resultSet.next()) {
				...
				registration.setMinutes(Utils.getDifferenceInMinutes(registration.getCheckInDate(), registration.getCheckOutDate()));
			}
